...
//
//public class FetchTimetableTask extends AsyncTask<String, Void, Void> {
//
//    private final String LOG_TAG = FetchTimetableTask.class.getSimpleName();
//    private final Context mContext;
//
//    public FetchTimetableTask(Context context) {
//        mContext = context;
//    }
//
//    /**
...
//                    TimetableContract.getDbDateString(new Date(dateTime * 1000L)));
