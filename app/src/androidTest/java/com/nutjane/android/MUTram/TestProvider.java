...
import com.nutjane.android.MUTram.data.TimetableContract;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void deleteAllRecords() {
        ...
        assertEquals(0, cursor.getCount()); //check equality of deleted
    ...
    public void testInsertReadProvider() {
        ...
        ContentValues testValues = TestDb.createFirstTramValue();

        Uri timetableUri = mContext.getContentResolver().insert(TimetableEntry.CONTENT_URI, testValues);
        ...
        cursor = mContext.getContentResolver().query(
                TimetableEntry.buildTimeUri(timetableRowId),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
...
//        TestDb.validateCursor(weatherCursor, weatherValues);
    ...
    public void testGetType() {
        ...
        // vnd.android.cursor.dir/com.nutjane.android.MUTram./timetabl
